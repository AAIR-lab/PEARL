...
class PinballObstacle:
    ...
    def __init__(self, points):
        ...
        self.shapely_obs = shapely.geometry.Polygon(points)
    ...
    def take_action(self, action):
        ...
        for i in range(20):
            ...
            if self.episode_ended():
                success = True
                return self.END_EPISODE, True, success

        self.ball.add_drag()
        self._check_bounds()

        if action == self.ACC_NONE:
            return self.STEP_PENALTY, False, success

        return self.THRUST_PENALTY, False, success # NEW: added success
